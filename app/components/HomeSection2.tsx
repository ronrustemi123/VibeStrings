...
const WhyTryCard = ({
  ...
  return (
    <div className={"text-center flex flex-col items-center gap-3 "}>
      <span
        className={
          "bg-[#262626] rounded-[20px] flex justify-center items-center p-5"
        }
      >
...
export default function HomeSection2() {
  return (
    <section className={"bg-black-text w-auto"}>
      <div
        className={
          "w-page-width mx-auto flex flex-col h-full min-h-[500px] py-12 items-center justify-center"
        }
      >
        <h1 className={"text-[44px] text-center text-white "}>
          Why try <span className={"text-accent  "}>VibeStrings?</span>
        </h1>
        <div
          className={
            "mt-24 flex flex-wrap justify-center  gap-12 md:justify-between items-center w-full"
          }
        >
          <WhyTryCard
            img={categoryIcon}
